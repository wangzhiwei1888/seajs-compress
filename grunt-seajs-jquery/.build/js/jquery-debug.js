 ...
 */
define("./dist/js/jquery-debug", [], function(require, exports, module) {
    (function(global, factory) {
        ...
        var version = "3.0.0-pre 055cb7534e2dcf7ee8ad145be83cb2d74b5331c7", // Define a local copy of jQuery
 ...
 */
        ...
        jQuery.extend({
                ...
                [ "notify", "progress", jQuery.Callbacks("memory"), jQuery.Callbacks("memory"), 2 ], [ "resolve", "done", jQuery.Callbacks("once memory"), jQuery.Callbacks("once memory"), 0, "resolved" ], [ "reject", "fail", jQuery.Callbacks("once memory"), jQuery.Callbacks("once memory"), 1, "rejected" ] ], state = "pending", promise = {
                    ...
                    then: function(onFulfilled, onRejected, onProgress) {
                        ...
                        function resolve(depth, deferred, handler, special) {
                            return function() {
                                var that = this === promise ? undefined : this, args = arguments, mightThrow = function() {
                                    var returned, then;
            ...
            // Deferred helper
            when: function() {
                var method, resolveContexts, i = 0, resolveValues = slice.call(arguments), length = resolveValues.length, // the count of uncompleted subordinates
                remaining = length, // the master Deferred.
                master = jQuery.Deferred(), // Update function for both resolving subordinates
                updateFunc = function(i) {
                    return function(value) {
                        resolveContexts[i] = this;
                        resolveValues[i] = arguments.length > 1 ? slice.call(arguments) : value;
                        if (!--remaining) {
                            master.resolveWith(resolveContexts.length === 1 ? resolveContexts[0] : resolveContexts, resolveValues);
                        }
                    };
                };
                ...
                if (length > 0) {
                    ...
                    for (;i < length; i++) {
                        ...
                        if (resolveValues[i] && jQuery.isFunction(method = resolveValues[i].promise)) {
                            method.call(resolveValues[i]).done(updateFunc(i)).fail(master.reject);
        ...
        function showHide(elements, show) {
            ...
            for (;index < length; index++) {
                ...
                if (show) {
                    ...
                    if (elem.style.display === "" && jQuery.css(elem, "display") === "none" && // Support: Firefox 43+
 ...
 */
        ...
        var rxhtmlTag = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi, // Support: IE 10-11, Edge 10240+
        ...
        function curCSS(elem, name, computed) {
            ...
            return ret !== undefined ? // Support: IE9-11 only
