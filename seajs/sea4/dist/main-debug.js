define("jwseajs/hello/1.0.0/main-debug", [ "./drag-debug", "./util-debug", "./limit-debug" ], function(require, exports, module) {
    //主函数
...
define("jwseajs/hello/1.0.0/drag-debug", [ "jwseajs/hello/1.0.0/util-debug", "jwseajs/hello/1.0.0/limit-debug" ], function(require, exports, module) {
    var util = require("jwseajs/hello/1.0.0/util-debug");
    var limit = require("jwseajs/hello/1.0.0/limit-debug").limit;
    function Drag(ele) {
        //ele可以拖动的元素
        //定义初始值
        this.x = 0;
...
define("jwseajs/hello/1.0.0/util-debug", [], function(require, exports, module) {
    /*
    * 主要就是一个工具库
    *
    * */
...
define("jwseajs/hello/1.0.0/limit-debug", [], function(require, exports, module) {
    //当前值 最大值 最小值
